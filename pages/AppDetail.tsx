...
import { Download, ChevronLeft, Calendar, Tag, Star, ShieldCheck } from 'lucide-react';
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                 ...
                 <div className="flex items-center gap-1 text-yellow-500">
                    ...
                    <span className="text-white text-sm font-bold">{app.rating}</span>
                    <span className="text-gray-500 text-xs">({app.reviewsCount} {t('reviews')})</span>
                 </div>
              </div>
