...
const Terms: React.FC = () => {
    ...
    // If no EULA, show message or redirect?
    if (!app.eula) {
        return (
            <div className="min-h-screen bg-dark pt-32 pb-20 flex items-center justify-center">
                <div className="text-center text-gray-400">
                    <p>No terms of use available for this application.</p>
                    <Link to={`/app/${app.id}`} className="text-primary hover:underline mt-4 inline-block">{t('details')}</Link>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-dark pt-32 pb-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <h1 className="text-4xl font-bold text-white mb-4">{app.name} {t('terms')}</h1>
